              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className={`w-4 h-4 rounded border focus:ring-green-500 focus:ring-2 ${form.online
                      ...
                      {(() => {
                        ...
                        return availableTimes.map((time) => (
                          <button
                            ...
                            className={`w-full py-3 text-sm rounded-xl border transition-all ${selectedTime === time
                        ...
                        {(() => {
                          ...
                          return availableTimes.map((time) => (
                            <div key={time} className="flex gap-2">
                              <button
                                onClick={() => handleTimeSelect(time)}
                                className={`flex-1 py-2.5 text-sm rounded-xl border border-gray-300 transition-all ${selectedTime === time
                                    ? "border-green-600 bg-green-600/10 text-green-600 font-medium"
