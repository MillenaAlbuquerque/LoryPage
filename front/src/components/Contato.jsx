        ...
        <section data-scroll-section className="bg-green-50" id="contato">
            <div className="flex flex-col lg:flex-row h-auto lg:h-screen items-center justify-center gap-6 lg:gap-10 px-6 lg:px-8 py-12 lg:py-0 max-w-7xl mx-auto w-full">
                ...
                <div className="group relative flex flex-col w-full lg:w-2/4 gap-4" data-scroll data-scroll-speed="2">
                    ...
                    <div className="relative h-58 w-full lg:absolute lg:-bottom-20 lg:-left-6 lg:z-20 lg:h-44 lg:w-76 overflow-hidden rounded-xl border border-green-300/80 shadow-xl transition-all duration-500 ease-in-out lg:hover:h-116 lg:hover:w-[calc(100%+2rem)]">
                        <Mapa className="h-full w-full" />
                    </div>
                </div>
            </div>
