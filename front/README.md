...
- **Sobre Mim** — seção com foto, texto e animação de hover com sombra dourada
...
`https://seu-usuario.github.io/LoryPage/`
...
- [ ] **Painel administrativo** — interface para a Lory visualizar e gerenciar os agendamentos recebidos
...
| Nome | GitHub |
|---|---|
| Você | [@seu-usuario](https://github.com/seu-usuario) |
...
- **Atendimento:** Presencial e Online | Segunda a Sábado, 8h às 18h

---

<p align="center">Feito com 💚 para a Lory Cavalcante</p>
